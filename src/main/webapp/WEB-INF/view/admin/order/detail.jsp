                                    ...
                                    <div class="row">
                                        <div class="col-12 mx-auto">
                                            <div class="d-flex justify-content-between">
                                                <h3>Detail with order id = ${order.orderId}</h3>
                                            </div>
                                            <hr />
                                            <div class="card">
                                                ...
                                                <ul class="list-group list-group-flush">
                                                    ...
                                                    <li class="list-group-item">Payment Method: ${order.paymentMethod}
                                                    </li>
                                                    <li class="list-group-item">Payment ID: ${order.payment.paymentId}
                                                    </li>
                                                </ul>
                                            </div>
                                            ...
                                            <table class="table table-striped mt-3">
                                                ...
                                                <tbody>
                                                    <c:forEach var="paymentDetail"
                                                        items="${order.payment.paymentDetails}">
                                                        <tr>
                                                            <td>${paymentDetail.course.courseId}</td>
                                                            <td>${paymentDetail.course.name}</td>
                                                            <td>${paymentDetail.course.description}</td>
                                                            <td>${paymentDetail.course.author}</td>
                                                            <td>${paymentDetail.course.hour}</td>
                                                            <td>
                                                                <fmt:formatNumber value="${paymentDetail.course.price}"
                                                                    type="currency" />
                                                            </td>
                                                            <td>${paymentDetail.course.star}</td>
                                                        </tr>
                                                    </c:forEach>
                                                </tbody>
                                            </table>
